...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := grpc.Invoke(ctx, "/protobuf.HelloService/Hello", in, out, c.cc, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := grpc.NewClientStream(ctx, &_HelloService_serviceDesc.Streams[0], c.cc, "/protobuf.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
var fileDescriptor0 = []byte{
	...
	0xa9, 0x12, 0x8c, 0x0a, 0x8c, 0x1a, 0x9c, 0x41, 0x10, 0x8e, 0x51, 0x1e, 0x17, 0x8f, 0x07, 0x48,
	0x63, 0x70, 0x6a, 0x51, 0x59, 0x66, 0x72, 0xaa, 0x90, 0x36, 0x17, 0x2b, 0x98, 0x2f, 0x24, 0xa0,
	0x07, 0x33, 0x43, 0x0f, 0x62, 0x80, 0x14, 0x86, 0x88, 0x90, 0x21, 0x17, 0xbb, 0x73, 0x46, 0x62,
	0x5e, 0x5e, 0x6a, 0x0e, 0x31, 0xca, 0x35, 0x18, 0x0d, 0x18, 0x93, 0xd8, 0xc0, 0x82, 0xc6, 0x80,
	0x00, 0x00, 0x00, 0xff, 0xff, 0x10, 0xd1, 0x8c, 0x7f, 0xaf, 0x00, 0x00, 0x00,
}
